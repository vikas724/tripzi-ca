<?php
$pagename = "MYSTIC CANADA 12/13 DAYS";
?>
<!doctype html>
        ...
        <div class="page-title__area pt-110" style="background-image: url(assets/img/about-us/ab-us.jpg);">
                ...
                <div class="row">
                    <div class="col-xxl-12">
                        <div class="page__title-wrapper text-center">
                            <h3 class="pb-100">MYSTIC CANADA 12/13 DAYS</h3>
                        </div>
                    </div>
                </div>
            </div>
            <nav class="breadccrumb-bg">
                <ul class="breadcrumb justify-content-center pt-20 pb-20">
                    ...
                    <li class="bd-items"> <a href="mystic-canada-13-12.php">CANADA</a></li>
                    <li class="bd-items bdritems">|</li>
                    <li class="bd-items"> <a href="mystic-canada-13-12.php">MYSTIC CANADA 12/13 DAYS</a></li>
                </ul>
            </nav>
        </div>
        <!-- page title area end -->
                    ...
                    <div class="row">
                            ...
                            <div class="sidebar__deatils">
                                <div class="visa-details">  
                                    <div class="visa-deatils__thumb mb-40">
                                        <img src="assets/img/Tours/mystic-canada.jpg" alt="">
                                    </div>
                        ...
                        <div class="necessary  mt-60">
                            <div class="row">
                                <div class="col-xxl-6 col-xl-6 " >
                                    <div class="necessary__box-thumb">
                                        <img src="assets/img/Tours/9.jpg" alt="">
                                    </div>
                                </div>
                                <div class="col-xxl-6 col-xl-6">
                                    <div class="necessary__box">
                        ...
                        <div class="necessary  mt-60">
                            <div class="row">
                                <div class="col-xxl-6 col-xl-6 " >
                                    <div class="necessary__box-thumb">
                                        <img src="assets/img/Tours/10.jpg" alt="">
                                    </div>
                                </div>
                                <div class="col-xxl-6 col-xl-6">
                                    <div class="necessary__box">
                        ...
                        <div class="necessary  mt-60">
                            <div class="row">
                                <div class="col-xxl-6 col-xl-6 " >
                                    <div class="necessary__box-thumb">
                                        <img src="assets/img/Tours/11.jpg" alt="">
                                    </div>
                                </div>
                                <div class="col-xxl-6 col-xl-6">
                                    <div class="necessary__box">
                        ...
                        <div class="necessary  mt-60">
                            <div class="row">
                                <div class="col-xxl-6 col-xl-6 " >
                                    <div class="necessary__box-thumb">
                                        <img src="assets/img/Tours/12.jpg" alt="">
                                    </div>
                                </div>
                                <div class="col-xxl-6 col-xl-6">
                                    <div class="necessary__box">
